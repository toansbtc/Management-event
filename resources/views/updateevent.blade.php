          ...
          <form method="POST" action="{{ url('/newevent') }}" enctype="multipart/form-data">
            @csrf
             ...
             <div class="form-group">
              ...
              <div class="col-sm-9">
              <input type="text" class="form-control" name="nameevent" id="nameevent" value="{{$event->nameevent}}">
              </div>
            </div> <!-- form-group // -->
            <div class="form-group">
              <label for="name" class="col-sm-3 control-label">start time</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" name="starttime" id="starttime" value="{{$event->starttime}}">
              </div>
            </div> <!-- form-group // -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="endtime" id="endtime" value="{{$event->endtime}}">
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <textarea name="introduct" id="introduct" class="form-control" >{{$event->introduct}}</textarea>
              </div>
            </div> <!-- form-group // -->
            <div class="row form-group" style="margin-left: 5px;">
              ...
              <div class="col-sm-3">
                  ...
                  <input type="text" class="form-control" name="location" id="location" value="{{$event->address}}">
              </div>
              <div class="col-sm-3">
                  <label for="qty" class="col-sm-3 control-label">trainer</label>
                  <input type="text" class="form-control" name="trainner" id="trainner" value="{{$event->nametrainer}}">
              </div>
